    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="radio" name="isChildNodeSave" id="isChildNode1Save" value="1" title="否" checked
                       lay-filter="isChildNodeHideShow">
            </div>
        </div>
    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="radio" name="isChildNodeUpdate" id="isChildNode1Update" value="1" title="否" checked
                       lay-filter="isChildNodeHideShow" disabled="disabled">
            </div>
        </div>
...
<script>
        ...
        layui.use(['table', 'form'], function () {
            ...
            table.on('tool(menuTable)', function (obj) { // 双击 toolDouble
                if (obj.event === 'del') {
                    ...
                    window.location.href = ctx + '/menuChild?pid=' + obj.data.id;
                }
            });
    ...
    function clearFormData() {
        ...
        $('#isChildNode1Save').prop("checked", true);// 是否有子节点
    ...
    function echoData(obj) {
        ...
        if (obj.data.isChildNode == 1) {
            ...
            $('#isChildNode2Update').prop("checked", true);
            $('#menuActionDiv2').hide();
        }
